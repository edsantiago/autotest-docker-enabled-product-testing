...
*  Run - When setup was successful, execute all necessary testng and
...
Referred to as the "kommandir", because it sounds much more important than "slave".
Here, specific, additional dependencies are configured, and utilized
